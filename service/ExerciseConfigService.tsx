...
export async function fetchExerciseConfigsForMuscleGroup(muscleId: number): Promise<ExerciseConfig[]> {  
        ...
        tx.executeSql(
          ...
          (tx, results) => {
            ...
            for (let i = 0; i < rows.length; i++) {
              const exerciseConfig: ExerciseConfig = rows.item(i) as ExerciseConfig
